    ...
    const experiences: Experiences[] =[{
        ...
        },
        {
            ...
            roles_responsibilities: [
                ...
                "Found more than 60+ bugs in the wise-marketing project including numerous base defects.",
                "Supported SRE team to deploy the released versions in 3 different regions for multiple projects.",
